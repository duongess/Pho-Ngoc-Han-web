...
const UI_TRANSLATIONS: Record<string, { vi: string; en: string }> = {
  ...
  'bestseller.title': { vi: 'Top 3 Món Bestseller', en: 'Top 3 Bestsellers' },
  'bestseller.desc': { vi: 'Ninh xương ống 18 tiếng, nước dùng ngọt thanh nguyên bản không mì chính, thịt tươi mềm dẻo thái tay mỗi sớm', en: '18-hour bone broth, naturally sweet with no MSG, fresh succulent meat hand-sliced each morning' },
  ...
  // Featured Dishes Aliases
  'dishes.eyebrow': { vi: 'Hương Vị Phở Hà Nội Thuần Khiết', en: 'Pure Hanoi Phở Flavors' },
  'dishes.title': { vi: 'Thực Đơn Phở Ngọc Hân', en: 'Phở Ngọc Hân Menu' },
  'dishes.subtitle': { vi: 'Ninh xương ống 18 tiếng • Không mì chính', en: '18-Hour Bone Broth • No MSG' },
  'dishes.desc': { vi: 'Chuyên các món phở bò truyền thống (tái, chín, gầu, gân, sốt vang), phở gà ta thả đồi thơm lá chanh, phở cuốn tươi mát và phở xào nóng hổi', en: 'Featuring traditional beef phở (rare, brisket, flank, tendon, red wine stewed), fragrant chicken phở, fresh noodle rolls, and sizzling stir-fried phở' },
  'dishes.view_detail': { vi: 'Xem chi tiết', en: 'View details' },
  ...
  // Locator Aliases
  'locator.seal': { vi: 'ĐIỂM HẸN', en: 'LOCATIONS' },
  'locator.heading': { vi: 'Hệ thống quán Phở Ngọc Hân', en: 'Phở Ngọc Hân Restaurant Locations' },
  'locator.subheading': { vi: 'Kính mời quý khách, thầy cô và các bạn sinh viên ghé thưởng thức bát phở nóng hổi', en: 'Warmly welcoming all guests, teachers, and students to enjoy our piping hot bowls' },
  'locator.find_nearest': { vi: 'Tìm quán gần nhất', en: 'Find Nearest Branch' },
  'locator.all_districts': { vi: 'Tất cả chi nhánh', en: 'All Branches' },
  'locator.search_placeholder': { vi: 'Tìm theo tên đường hoặc quận...', en: 'Search by street name or district...' },
  'locator.directions': { vi: 'Chỉ đường Google Maps', en: 'Get Directions' },
  'locator.hotline': { vi: 'Hotline:', en: 'Hotline:' },
  'locator.hours': { vi: 'Giờ mở cửa:', en: 'Hours:' },
  'locator.empty': { vi: 'Không tìm thấy cơ sở quán nào phù hợp với tìm kiếm của bạn.', en: 'No restaurant locations found matching your search.' },
  ...
  // Cart Drawer
  'cart.title': { vi: 'Giỏ phở của bạn', en: 'Your Phở Cart' },
  'cart.title_cart': { vi: 'Giỏ phở của bạn', en: 'Your Phở Cart' },
  'cart.checkout_title': { vi: 'Thông tin giao hàng', en: 'Delivery Details' },
  'cart.title_checkout': { vi: 'Thông tin giao hàng', en: 'Delivery Details' },
  'cart.success_title': { vi: 'Đặt món thành công', en: 'Order Successful' },
  'cart.title_success': { vi: 'Đặt món thành công', en: 'Order Successful' },
  'cart.items_count': { vi: 'phần', en: 'items' },
  'cart.promo_banner': { vi: 'Ưu đãi quán Cô Hân: Được tặng {count} đĩa quẩy giòn thơm khi đặt từ 2 bát phở!', en: 'Special offer: Complimentary {count} plate(s) of crispy crullers for ordering 2+ bowls!' },
  ...
  'cart.empty_desc': { vi: 'Khám phá thực đơn và chọn món phở nóng hổi bạn yêu thích nhé!', en: 'Explore our menu and choose your favorite steaming hot bowls!' },
  ...
  'cart.empty_btn': { vi: 'Khám phá thực đơn ngay', en: 'Explore Menu Now' },
  ...
  'cart.shipping_fee': { vi: 'Phí giao hàng:', en: 'Delivery fee:' },
  'cart.free_shipping': { vi: 'Miễn phí (nội thành)', en: 'Free (inner city)' },
  'cart.free_inner_city': { vi: 'Miễn phí (nội thành)', en: 'Free (inner city)' },
  'cart.total': { vi: 'Tổng thanh toán:', en: 'Total Amount:' },
  'cart.total_payment': { vi: 'Tổng thanh toán:', en: 'Total Amount:' },
  ...
  'cart.name_label': { vi: 'Họ và tên người nhận', en: 'Recipient Full Name' },
  'cart.customer_name': { vi: 'Họ và tên người nhận', en: 'Recipient Full Name' },
  'cart.name_placeholder': { vi: 'Ví dụ: Nguyễn Văn Nam', en: 'e.g. John Doe' },
  'cart.phone': { vi: 'Số điện thoại', en: 'Phone Number' },
  'cart.phone_label': { vi: 'Số điện thoại', en: 'Phone Number' },
  'cart.address': { vi: 'Địa chỉ nhận phở (Số nhà, tên đường, phường...)', en: 'Delivery Address (Street, building, ward...)' },
  'cart.address_label': { vi: 'Địa chỉ nhận phở (Số nhà, tên đường, phường...)', en: 'Delivery Address (Street, building, ward...)' },
  'cart.address_placeholder': { vi: 'Số nhà, ngõ/ngách, tên đường, phường...', en: 'Street name, building, apartment...' },
  'cart.note_label': { vi: 'Ghi chú cho quán (tùy chọn)', en: 'Special notes (optional)' },
  'cart.notes': { vi: 'Ghi chú cho quán (VD: nhiều hành, nước béo, ít bánh...)', en: 'Special notes (e.g. extra scallions, rich broth...)' },
  'cart.note_placeholder': { vi: 'Ví dụ: nhiều hành, ít nước béo, mang nhiều ớt tươi...', en: 'e.g. extra scallions, less oil, extra chili...' },
  'cart.payment_method': { vi: 'Hình thức thanh toán:', en: 'Payment method:' },
  'cart.cod': { vi: 'Tiền mặt khi nhận phở (COD)', en: 'Cash on delivery (COD)' },
  'cart.confirm_btn': { vi: 'XÁC NHẬN ĐẶT PHỞ NGAY', en: 'CONFIRM & PLACE ORDER NOW' },
  'cart.back_btn': { vi: 'Quay lại giỏ hàng', en: 'Back to cart' },
  ...
  'cart.success_desc': { vi: 'Quán Cô Hân đã nhận đơn của {name} ({phone}) và đang chuẩn bị nước dùng sôi sùng sục. Shipper sẽ giao tới bạn trong 25 - 35 phút!', en: 'Teacher Han has received the order for {name} ({phone}) and is preparing piping hot broth. Delivery will arrive in 25 - 35 minutes!' },
  ...
  'cart.order_code': { vi: 'Mã đơn hàng:', en: 'Order code:' },
  'cart.finish_btn': { vi: 'HOÀN TẤT & ĐÓNG', en: 'FINISH & CLOSE' },
  'cart.close_btn': { vi: 'HOÀN TẤT & ĐÓNG', en: 'FINISH & CLOSE' },

  // Reservation Modal
  'reservation.seal': { vi: 'ĐẶT BÀN', en: 'RESERVATION' },
  'reservation.title': { vi: 'Đặt bàn tại Phở Ngọc Hân', en: 'Table Reservation at Phở Ngọc Hân' },
  'reservation.subtitle': { vi: 'Kính mời quý khách điền thông tin để Cô Hân và quán chuẩn bị bàn ghế tươm tất cùng nước dùng nóng hổi đón tiếp quý khách.', en: 'Please provide your details so Teacher Han and staff can prepare a cozy table and hot broth for your arrival.' },
  'reservation.branch_label': { vi: 'Chọn chi nhánh quán', en: 'Select Branch' },
  'reservation.date_label': { vi: 'Ngày đến thưởng thức', en: 'Arrival Date' },
  'reservation.time_label': { vi: 'Giờ hẹn', en: 'Arrival Time' },
  'reservation.guests_label': { vi: 'Số lượng khách', en: 'Number of Guests' },
  'reservation.guests_suffix': { vi: 'người', en: 'guests' },
  'reservation.name_label': { vi: 'Họ và tên quý khách', en: 'Full Name' },
  'reservation.name_placeholder': { vi: 'Ví dụ: Nguyễn Văn An', en: 'e.g. John Smith' },
  'reservation.phone_label': { vi: 'Số điện thoại liên hệ', en: 'Phone Number' },
  'reservation.note_label': { vi: 'Ghi chú đặc biệt (tùy chọn)', en: 'Special Requests (optional)' },
  'reservation.note_placeholder': { vi: 'Ví dụ: Bàn gần cửa sổ, nhóm sinh viên Xây Dựng họp lớp...', en: 'e.g. Table near window, class reunion...' },
  'reservation.submit_btn': { vi: 'XÁC NHẬN ĐẶT BÀN TRƯỚC', en: 'CONFIRM RESERVATION' },
  'reservation.success_title': { vi: 'Đặt bàn thành công!', en: 'Reservation Confirmed!' },
  'reservation.success_desc': { vi: 'Cảm ơn quý khách {name}! Quán Phở Ngọc Hân đã ghi nhận thông tin bàn cho {guests} người vào lúc {time} ngày {date} tại chi nhánh {branch}. Quán sẽ gọi hotline xác nhận trước giờ đón tiếp chu đáo.', en: 'Thank you {name}! Phở Ngọc Hân has confirmed your table for {guests} guest(s) at {time} on {date} at {branch}. We will contact you shortly to ensure a wonderful dining experience.' },
  'reservation.address_label': { vi: 'Địa chỉ quán:', en: 'Address:' },
  'reservation.hotline_label': { vi: 'Hotline hỗ trợ:', en: 'Hotline:' },
  'reservation.close_btn': { vi: 'Đã hiểu & Đóng', en: 'Got it & Close' },
  ...
  // Search Modal
  'search.seal': { vi: 'TÌM MÓN', en: 'SEARCH' },
  ...
  'search.results_title': { vi: 'Tìm thấy {count} món phù hợp', en: 'Found {count} matching dishes' },
  'search.suggested_title': { vi: 'Gợi ý món ăn nổi bật', en: 'Recommended Dishes' },
  'search.order_btn': { vi: 'Đặt món', en: 'Order' },
  ...
  'dish_modal.broth_note': { vi: 'Nước dùng ninh 18 tiếng từ xương ống bò tươi, thảo mộc thơm, không mì chính hóa chất.', en: '18-hour slow-simmered beef bone broth with aromatic herbs, no MSG.' },
  'dish_modal.added': { vi: 'Đã thêm vào giỏ hàng!', en: 'Added to cart!' },
  'dish_modal.add_btn': { vi: 'Thêm vào giỏ hàng • ', en: 'Add to Cart • ' },
